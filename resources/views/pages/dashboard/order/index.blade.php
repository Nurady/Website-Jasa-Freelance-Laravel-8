                                ...
                                @forelse ($orders as $key => $order)
                                    <tr class="text-gray-700 border-b">
                                        ...
                                        <td class="w-2/6 px-1 py-5">
                                            <div class="flex items-center text-sm">
                                                <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                    @if (count($order->service->thumbnails_service))
                                        ...
                                        <td class="px-1 py-5 text-sm">
                                            @if($order->order_status_id == '1')
                                                ...
                                                <p class="inline px-4 py-2 mt-2 text-left text-green-500">
                                                    Approved
                                                </p>
                                            ...
                                            @elseif($order->order_status_id == '3')
                                                ...
                                                <p class="inline px-4 py-2 mt-2 text-left text-red-500">
                                                    Rejected
                                                </p>
                                            @elseif($order->order_status_id == '4')
                                                <a href="{{ route('member.order.accepted', $order->id) }}" class="px-4 py-2 mt-2 text-left text-white rounded-xl bg-serv-button">
                                                    Accept
                                                </a>

                                                <a href="{{ route('member.order.rejected', $order->id) }}" class="px-4 py-2 mt-2 text-left bg-white rounded-xl">
                                                    Reject
                                                </a>
                                            @else
                                                {{ 'N/A' }}
