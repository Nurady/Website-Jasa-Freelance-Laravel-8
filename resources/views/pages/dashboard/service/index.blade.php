                                            ...
                                            <td class="w-2/6 px-1 py-5">
                                                <div class="flex items-center text-sm">
                                                    <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                        @if (isset($service->thumbnails_service[0]->thumbnail) != NULL)
                                                            <img class="object-cover w-full h-full rounded" src="{{ url(Storage::url($service->thumbnails_service[0]->thumbnail)) }}" alt="thumbnail-service" loading="lazy" />
                                                        @else
