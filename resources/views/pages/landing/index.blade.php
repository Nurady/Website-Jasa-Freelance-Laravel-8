            ...
            <div class="flex flex-col px-8 pt-16 pb-16 mx-auto lg:pb-20 lg:px-24 md:px-16 sm:px-8 lg:flex-row">
                ...
                <div
                    ...
                    <h1
                        ...
                        Get Your Web Apps <br class="hidden lg:block">
                        With Our Best Team
                    </h1>
                    <p class="mb-10 text-lg font-light leading-relaxed tracking-wide text-serv-text lg:mb-18 ">
                        Freelancer Platform which skills and experience Knowledge<br class="hidden lg:block">
                        to helps your accomplish Website.<br class="hidden lg:block">
                    </p>
                    <div
                        class="items-center justify-center mx-auto space-x-0 md:flex contents lg:mx-0 lg:flex lg:space-x-8 md:space-x-2">
                        <button class="px-12 py-4 my-2 text-lg font-semibold text-white rounded-lg bg-serv-button" onclick="toggleModal('registerModal')">
                            Get Started
                        </button>
                    </div>
                </div>
