...
@section('content')
     ...
     <section class="w-auto flex min-h-[85vh] pt-6 pb-20 mx-auto lg:mx-12 px-4">
        <div class="h-auto m-auto text-center">
            ...
            <a href="http://wa.me/628123456789" class="inline-block py-4 my-2 font-medium text-center text-white bg-serv-button text-md w-80 rounded-2xl">
                Continue to Chat
            </a>
            <br>
            <a href="{{ route('index') }}" class="inline-block py-4 my-2 font-medium text-center bg-serv-services-bg text-serv-bg text-md w-80 rounded-2xl">
                Back to Home
            </a>
